...
Call log:
  - navigating to "http://localhost:3000/tools/sidekick/library.html?plugin=blocks&path=/tools/sidekick/library/templates/tabs&index=0&vtest=true", waiting until "load"
...
```ts
  ...
  256 |     const screenshotName = 'tabs-variation-0-tablet.png';
  ...
  299 |     const screenshotName = 'tabs-variation-0-desktop.png';
...
> 315 |     await page.goto('/tools/sidekick/library.html?plugin=blocks&path=/tools/sidekick/library/templates/tabs&index=0&vtest=true');
  ...
  342 |     const screenshotName = 'tabs-variation-0-large.png';
  ...
  385 |     const screenshotName = 'tabs-variation-1-mobile.png';
